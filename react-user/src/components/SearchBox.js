...
const SearchBox = () => {
  ...
  const names = [
    ...
    //   description: "Okay not a day goes by that I don’t use this product lol. I am  Truly in love with this toner. Omg I use it during my morning routine . Right after using my Brick Size : 4*8*12 facial cleanser.    ",
    //   stars: 5,
    // },
